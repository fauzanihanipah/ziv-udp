...
update_script() {
    ...
    # --- Configuration ---
    REPO_URL="https://raw.githubusercontent.com/roodyzain99/udp-zivpn/main"
    # Assuming the release version might get updated, but for now, this is the latest known one.
    RELEASE_URL="https://github.com/roodyzain99/udp-zivpn/releases/download/udp-zivpn_1.4.9"
